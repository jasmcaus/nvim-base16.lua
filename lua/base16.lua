...
local function apply_base16_theme(theme)
    ...
    highlight("Boolean",      theme.base08, nil, nil, nil)
    highlight("Character",    theme.base08, nil, nil, nil)
    highlight("Comment",      "#768390", nil, nil, nil)
    highlight("Conditional",  theme.base08, nil, nil, nil)
    highlight("Constant",     theme.base0D, nil, nil, nil)
    highlight("Define",       theme.base08, nil, "none", nil)
    highlight("Delimiter",    theme.base0F, nil, nil, nil)
    highlight("Float",        theme.base08, nil, nil, nil)
    highlight("Function",     theme.base08, nil, nil, nil)
    ...
    highlight("Number",       theme.base08, nil, nil, nil)
    ...
    highlight("String",       theme.base0C, nil, nil, nil)
    ...
    highlight("Type",         theme.base07, nil, "none", nil)
